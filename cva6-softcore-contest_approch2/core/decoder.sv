...
// // ↓↓↓ Modification ↓↓↓
        // Custom instruction MAC4 (Opcode: 0001011)
        7'b0001011: begin 
          imm_select             = RS3;             // use RS3 to fetch the accumulator
          instruction_o.fu       = CVXIF;            // Dispatch the task to the coprocessor unit
          ...
          if (instr.rtype.funct3 == 3'b001) begin
            instruction_o.op = ariane_pkg::MAC4;  // Attach the MAC4  label we registered in ariane_pkg
          end else begin
