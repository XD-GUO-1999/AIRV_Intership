...
//modification to debug
  ...
  assign mult_valid      = mult_valid_i && (operation_i inside {MUL, MULH, MULHU, MULHSU, MULW, CLMUL, CLMULH, CLMULR, ariane_pkg::MAC16BUF, ariane_pkg::BUF4}); //modification: add MAC8IM
  ...
  always_comb begin : p_selmux
    ...
    unique case (operator_q)
      ariane_pkg::MAC16BUF:    result_o = mac8ex_res_q; //modification: output of mac8im
