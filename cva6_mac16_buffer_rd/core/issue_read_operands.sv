...
#(
  ...
  always_comb begin : operands_available
    ...
    //modification: we don't need rs3 for mac16 anymore
   ...
   //////
    ...
    if ((CVA6Cfg.FpPresent && is_imm_fpr(
        ...
        //modification
            (issue_instr_i.op == OFFLOAD) && CVA6Cfg.NrRgprPorts == 5 ?
  ...
  always_comb begin : forwarding_operand_select
    ...
    if (CVA6Cfg.NrRgprPorts == 5) begin//modification 3 -> 5
      imm_n = (CVA6Cfg.FpPresent && is_imm_fpr(issue_instr_i.op)) ?
          ...
          (issue_instr_i.op == OFFLOAD) ? operand_c_regfile : issue_instr_i.result; //modification : delet MAC16BUF
    end else begin
      imm_n = (CVA6Cfg.FpPresent && is_imm_fpr(issue_instr_i.op)) ?
...
//modification
  ...
  always_comb begin : issue_scoreboard
    ...
    if (issue_instr_valid_i) begin
      ...
      if (!stall && !fu_busy) begin
        ...
        //modification of the WAW check
        if (issue_instr_i.op == ariane_pkg::MAC16BUF || issue_instr_i.op == ariane_pkg::ACC_INIT || issue_instr_i.op == ariane_pkg::BUF4) begin
          issue_ack_o = 1'b1;
        end else if ((CVA6Cfg.FpPresent && ariane_pkg::is_rd_fpr(
                issue_instr_i.op
  ...
  assign raddr_pack = {
        ...
        (issue_instr_i.op == ariane_pkg::MAC16BUF || issue_instr_i.op == ariane_pkg::BUF4) ? 5'd0 : issue_instr_i.result[4:0], // Port 3: rd/acc
