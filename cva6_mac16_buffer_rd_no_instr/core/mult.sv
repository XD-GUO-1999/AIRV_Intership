...
#(
  ...
  // Input Arbitration
//modification
  assign mul_valid_op = ~flush_i && mult_valid_i && (fu_data_i.operation inside { MUL, MULH, MULHU, MULHSU, MULW, CLMUL, CLMULH, CLMULR, ariane_pkg::MAC16BUF, ariane_pkg::BUF4});
//modofocation
