  ...
  always_comb begin
    ...
    if (x_valid_i) begin
      ...
      if (cvxif_pkg::X_NUM_RS == 9) begin //modification
        ...
        cvxif_req_o.x_issue_req.rs[5] = fu_data_i.operand_f;
        cvxif_req_o.x_issue_req.rs[6] = fu_data_i.operand_g;
        cvxif_req_o.x_issue_req.rs[7] = fu_data_i.operand_h;
        cvxif_req_o.x_issue_req.rs[8] = fu_data_i.operand_i;
